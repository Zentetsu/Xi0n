...
// METHODES
	...
	*/
	...
	public boolean equals ( Calibration calibration ) {
		return ( this.leftDirection==calibration.leftDirection && this.leftPower0to255== calibration.leftPower0to255 && this.rightDirection == calibration.rightDirection && this.rightPower0to255 == calibration.rightPower0to255 );
	}
